  ...
  ubicacionesAleatorias.forEach(bicicleta => {
    var popupContentBici = `
      <div class="bg-[#2e3649] p-2 text-white max-w-xs">
        ...
        <input id="input-alert" type="text" class="block w-full mb-2 border p-2 rounded text-black" placeholder="Ingresa tu destino">
...
listaDeCoordenadasParadas.forEach(parada=>{
    var popupContent = `
    <div class=" bg-[#2e3649] p-2 text-white max-w-xs">
    <div class="popup-title text-lg font-semibold mb-2">Parada de ${parada.nombreParada}</div>
    <div class="popup-description text-sm mb-2">Actualmente cuenta con <span class="font-semibold">${parada.bici}</span> bicis disponibles.</div>
...
`;
 ...
 var ubicontent = `
    ...
    <p class="border-none bg-[#2e3649] text-[10px] text-white p-2 hover:bg-[#0acc73]">
      Estoy aqui
    <p/> 
